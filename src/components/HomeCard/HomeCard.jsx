     ...
     return (
          <div className=" font-serif">
               ...
               <div className=" grid xl:grid-cols-3 lg:grid-cols-2 gap-10 justify-center items-center w-full max-w-[80%]  mx-auto mt-20 ">
                    {card.map((card, index) => (
                         <div
                              className=" bg-main p-12 px-12 space-y-5 rounded-md max-w-sm mx-auto  shadow-none transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-white md:h-[350px] "
                              key={index}>
